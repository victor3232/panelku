...
╭─〔 🎨 OS SUPPORT 〕
│ 🖥️ Ubuntu 20 Debian 11 〔 V1 〕
│ 🔓 Debian 12 Ubuntu 22 & 24〔 V2 〕
╰───────────────────⟢

╭─〔 ⛔ NO SPAM INSTALL BOT 〕
│ ⏯️ Beri Jeda Jika Install Banyak 
╰───────────────────⟢

╭─〔 ⏰ BOT ONLINE 24 JAM 〕
│ 🌐 Memakai Hosting Berbayar Legal
╰───────────────────⟢
  ...
  // kirim menu awal
  bot.sendMessage(chatId, menuText, mainKeyboard);
});
...
bot.on('callback_query', (callbackQuery) => {
  ...
  if (data === 'admin') {
    ...
    bot.sendMessage(chatId, 'Jika Ada Kendala / Eror Silahkan Hubungi Admin @kibiljoe');
  }
  ...
  if (data === 'donasi') {
    ...
    const qrisImageUrl = "https://qu.ax/xmhfH.jpg"; // QRIS kamu
    bot.sendPhoto(chatId, qrisImageUrl, {
      caption: "🙏 Silakan scan QRIS untuk donasi. Terima kasih atas dukunganmu!",
      reply_markup: {
        inline_keyboard: [
          [{ text: '⬅️ Kembali ke Menu Start', callback_data: 'start' }]
        ]
      }
    });
  }
